        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                <form action="{{ route('peliculas.index') }}" method="GET">
                    <input type="text" name="search" placeholder="Buscar pelicula..." class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">
                                    @if ($pelicula->poster)
                                        <a href="{{ asset($pelicula->poster) }}" data-fancybox>
                                            <img src="{{ asset($pelicula->poster) }}" alt="pelicula actual" class="mt-2 rounded-md" style="max-width: 50px; max-height: 50px;">
                                        </a>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">

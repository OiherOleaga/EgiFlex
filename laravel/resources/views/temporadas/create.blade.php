        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <form action="{{ route('temporadas.store') }}" method="POST" class="space-y-8 divide-y divide-gray-200 dark:divide-gray-700">
                        @csrf
                        ...
                        <div class="space-y-8 divide-y divide-gray-200 dark:divide-gray-700 sm:space-y-5">
                            <div class="space-y-6 sm:space-y-5">
                                    ...
                                    <div class="mt-1">
                                        <select name="id_serie" id="id_serie" class="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md">
                                            @foreach($series as $serie)
                                                <option value="{{ $serie->id }}">{{ $serie->titulo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="number" name="numero_temporada" id="numero_temporada" autocomplete="numero_temporada" min="1" class="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="number" name="numero_episodios" id="numero_episodios" autocomplete="numero_episodios" min="1" class="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md">
                                    </div>
                                </div>
